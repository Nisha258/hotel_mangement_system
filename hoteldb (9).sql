...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2024 at 02:14 PM
...
INSERT INTO `bill1` (`bill_no`, `name`, `contact`, `date`, `roomtype`, `roomno`, `cost`) VALUES
(6774, 'nisha', 987878789, '2024-03-18 18:39:10', 'double', 2, 1200);
...
--
ALTER TABLE `bill1`
  MODIFY `bill_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6775;
